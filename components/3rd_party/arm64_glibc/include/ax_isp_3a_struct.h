...
#define AX_AE_FACE_LUMA_DIFF_LEVEL (5)
#define AX_AE_FACE_DETECTION_MAX_NUM (10)

typedef struct{
    AX_U8      nSize;                                 /* Accuracy: U8 Range: [0x0, 0x5] */
    AX_U32     nFaceLumaDiff[AX_AE_FACE_LUMA_DIFF_LEVEL];     /* the luma diff between face weighted meanluma and background weighted meanluma. Accuracy: U9.10 Range: [0x0, 0x4 0000]*/
    AX_U32     nFaceWeight[AX_AE_FACE_LUMA_DIFF_LEVEL]; /* the weight of face meanluma counted into frame meanluma; Accuracy: U1.10 Range: [0x0, 0x400] */
...
typedef struct
{
    ...
    AX_U16 nFaceScoreList[AX_AE_FACE_SCORE_LEVEL];               /* Face score level list:order from low to high. Accuracy: U1.10 Range: [0x0, 0x400] */
    AX_U16 nFaceScoreWeightList[AX_AE_FACE_SCORE_LEVEL];         /* Weight table based on score level: order from low to high. Accuracy: U1.10 Range: [0x0, 0x400] */
    AX_U16 nFaceDistanceList[AX_AE_FACE_DISTANCE_LEVEL];       /* Face distance between image center and face center;order from low to high. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_U16 nFaceDistanceWeightList[AX_AE_FACE_DISTANCE_LEVEL];         /* Distance weight table: for calculating face score:order from high to low. Accuracy: U1.10 Range: [0x0, 0x400] */
...
typedef struct {
    AX_U16 nFaceStartX;                   /* Face ROI start point. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_U16 nFaceStartY;                   /* Face ROI start point. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_U16 nFaceWidth;                    /* Face ROI width. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_U16 nFaceHeight;                   /* Face ROI height. Accuracy: U1.10 Range: [0x0, 0x400]*/
...
typedef struct {
    ...
    AX_U16 nFaceConfidence[AX_AE_FACE_DETECTION_MAX_NUM];             /* Confidence of each face. Accuracy: U1.10 Range: [0x0, 0x400]*/
...
typedef struct
{
    AX_U8  nEnableSleepSetting; /* 0: dynamic settings 1: fixed settings */
...
typedef struct {
    ...
    AX_U32 nLumaHdrRealRatioLtoS;  /* Accuracy: U7.10  Range: [0x400, 0x1FC00] */
    AX_U32 nSetPoint;           /* Accuracy: U8.10  Range: [0x0, 0x3FC00] */
