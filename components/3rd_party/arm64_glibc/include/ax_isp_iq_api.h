...
typedef struct {
    ...
    AX_S32    nBiasOut[AX_ISP_AINR_OFFSET_NUM];                                       /*Accuracy: U16.4 Range: [-4096,4095],Default:[0,0,0,0]*/
...
typedef struct {
    ...
    AX_S32    nBiasOut[AX_ISP_AINR_REF_VALUE_MAX_NUM][AX_ISP_AINR_OFFSET_NUM];              /* Accuracy: U16.4 Range: [-4096,4095],Default:[0,0,0,0]*/
...
typedef struct {
    ...
    AX_U16 nKMax[AX_ISP_REF_AUTOTBL_RLTM_EXPRESS_NUM];              /* limit brightness. Accuracy: U8.8 Range: [256, 65535], default 1024 */
