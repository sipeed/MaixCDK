...
typedef struct axMD_MB_SAD_T {
    AX_U32 u32Count; /* MB count */
    AX_U8 *pMbSad;  /* 0 ~ 255 of each MB */
} AX_MD_MB_SAD_T;
...
/// @param pstMbSad [O]: return the detected sum of absolute difference.
/// @param pstBlob  [O]: return the detected connectivity region.
///
/// @return 0 if success, otherwise failure
//////////////////////////////////////////////////////////////////////////////////////
AX_S32 AX_IVES_MD_Process(MD_CHN mdChn, AX_IVES_IMAGE_T *pstCur, AX_MD_MB_THR_T *pstMbThr, AX_MD_MB_SAD_T *pstMbSad, AX_IVES_CCBLOB_T *pstBlob);
