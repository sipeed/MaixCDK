...
/// @return 0 if success, otherwise failure
//////////////////////////////////////////////////////////////////////////////////////
AX_S32 AX_SKEL_Search_Create(AX_U64 nGroupId, const AX_SKEL_SEARCH_GROUP_PARAM_T *pstParam);
...
/// @brief compare
///
/// @param pstFeature1 [I]: feature1
/// @param pstFeature2 [I]: feature2
/// @param pfScore     [O]: return the score of comparison
///
/// @return 0 if success, otherwise failure
//////////////////////////////////////////////////////////////////////////////////////
AX_S32 AX_SKEL_Search_Compare(const AX_SKEL_FEATURE_ITEM_T *pstFeature1, const AX_SKEL_FEATURE_ITEM_T *pstFeature2, AX_F32 *pfScore);
