...
({                                                                      \
    ...
    __typeof__(invert) _invert = (invert);                              \
    int8_t _l, _a, _b;                                                  \
    COLOR_RGB888_TO_LAB(_pixel, &_l, &_a, &_b);                         \
    ((_threshold->LMin <= _l) && (_l <= _threshold->LMax) &&            \
    (_threshold->AMin <= _a) && (_a <= _threshold->AMax) &&             \
    (_threshold->BMin <= _b) && (_b <= _threshold->BMax)) ^ _invert;    \
})
...
// RGB888 Stuff //
#define COLOR_RGB888_TO_R8(pixel)   (pixel.r)
#define COLOR_RGB888_TO_G8(pixel)   (pixel.g)
#define COLOR_RGB888_TO_B8(pixel)   (pixel.b)

#define COLOR_R5_G6_B5_TO_RGB565(r5, g6, b5)    (((r5) << 11) | ((g6) << 5) | (b5))
#define COLOR_R8_G8_B8_TO_RGB565(r8, g8, b8)    ((((r8) & 0xF8) << 8) | (((g8) & 0xFC) << 3) | ((b8) >> 3))
#define COLOR_R8_G8_B8_TO_RGB888(r8, g8, b8)    ({pixel_rgb_t __rgb = { .r = (r8), .g = (g8), .b = (b8) }; __rgb;})

#ifdef IMLIB_ENABLE_YUV_LUT
extern const int8_t yuv_table[196608];
#define COLOR_RGB888_TO_Y(r8, g8, b8)           ((uint8_t)yuv_table[(COLOR_R8_G8_B8_TO_RGB565(r8, g8, b8) * 3) + 0])
#define COLOR_RGB888_TO_U(r8, g8, b8)           yuv_table[(COLOR_R8_G8_B8_TO_RGB565(r8, g8, b8) * 3) + 1]
#define COLOR_RGB888_TO_V(r8, g8, b8)           yuv_table[(COLOR_R8_G8_B8_TO_RGB565(r8, g8, b8) * 3) + 2]
#define COLOR_RGB565_TO_Y(rgb565)               yuv_table[((rgb565) * 3) + 0]
#define COLOR_RGB565_TO_U(rgb565)               yuv_table[((rgb565) * 3) + 1]
#define COLOR_RGB565_TO_V(rgb565)               yuv_table[((rgb565) * 3) + 2]
#else
...
extern const int8_t lab_table2[196608];
...
#define COLOR_RGB888_TO_L(pixel)                lab_table[(((COLOR_R8_G8_B8_TO_RGB565(COLOR_RGB888_TO_R8(pixel), COLOR_RGB888_TO_G8(pixel), COLOR_RGB888_TO_B8(pixel))) >> 1) * 3) + 0]
#define COLOR_RGB888_TO_A(pixel)                lab_table[(((COLOR_R8_G8_B8_TO_RGB565(COLOR_RGB888_TO_R8(pixel), COLOR_RGB888_TO_G8(pixel), COLOR_RGB888_TO_B8(pixel))) >> 1) * 3) + 1]
#define COLOR_RGB888_TO_B(pixel)                lab_table[(((COLOR_R8_G8_B8_TO_RGB565(COLOR_RGB888_TO_R8(pixel), COLOR_RGB888_TO_G8(pixel), COLOR_RGB888_TO_B8(pixel))) >> 1) * 3) + 2]
#define COLOR_RGB888_TO_LAB(pixel, l, a, b)     \
    ({\
        uint16_t rgb565_idx = (COLOR_R8_G8_B8_TO_RGB565(COLOR_RGB888_TO_R8(pixel), COLOR_RGB888_TO_G8(pixel), COLOR_RGB888_TO_B8(pixel)) >> 1) * 3;\
        (*l) = lab_table[rgb565_idx + 0];\
        (*a) = lab_table[rgb565_idx + 1];\
        (*b) = lab_table[rgb565_idx + 2];\
    })
#else
#define COLOR_RGB565_TO_L(pixel)                lab_table2[((pixel) * 3) + 0]
#define COLOR_RGB565_TO_A(pixel)                lab_table2[((pixel) * 3) + 1]
#define COLOR_RGB565_TO_B(pixel)                lab_table2[((pixel) * 3) + 2]
#define COLOR_RGB888_TO_L(pixel)                lab_table2[((uint32_t)((COLOR_R8_G8_B8_TO_RGB565(COLOR_RGB888_TO_R8(pixel), COLOR_RGB888_TO_G8(pixel), COLOR_RGB888_TO_B8(pixel)))) * 3) + 0]
#define COLOR_RGB888_TO_A(pixel)                lab_table2[((uint32_t)((COLOR_R8_G8_B8_TO_RGB565(COLOR_RGB888_TO_R8(pixel), COLOR_RGB888_TO_G8(pixel), COLOR_RGB888_TO_B8(pixel)))) * 3) + 1]
#define COLOR_RGB888_TO_B(pixel)                lab_table2[((uint32_t)((COLOR_R8_G8_B8_TO_RGB565(COLOR_RGB888_TO_R8(pixel), COLOR_RGB888_TO_G8(pixel), COLOR_RGB888_TO_B8(pixel)))) * 3) + 2]
#define COLOR_RGB888_TO_LAB(pixel, l, a, b)     \
    ({\
        uint32_t rgb565_idx = (COLOR_R8_G8_B8_TO_RGB565(COLOR_RGB888_TO_R8(pixel), COLOR_RGB888_TO_G8(pixel), COLOR_RGB888_TO_B8(pixel))) * 3;\
        (*l) = lab_table2[rgb565_idx + 0];\
        (*a) = lab_table2[rgb565_idx + 1];\
        (*b) = lab_table2[rgb565_idx + 2];\
    })
#endif
#else
...
#define COLOR_RGB888_TO_LAB(pixel, l, a, b)     imlib_rgb888_to_lab(pixel, l, a, b)
#endif
...
#define COLOR_RGB888_TO_GRAYSCALE(pixel)        COLOR_RGB888_TO_Y(pixel.r, pixel.g, pixel.b)
#define COLOR_RGB888_TO_BINARY(pixel)           (COLOR_RGB888_TO_Y(pixel.r, pixel.g, pixel.b) > (((COLOR_Y_MAX - COLOR_Y_MIN) / 2) + COLOR_Y_MIN))
#define COLOR_BINARY_TO_RGB888(pixel)           COLOR_YUV_TO_RGB888(((pixel) ? 127 : -128), 0, 0)
#define COLOR_YUV_TO_R8(y, u, v)                (IM_MAX(IM_MIN(y + ((91881 * v) >> 16), COLOR_R8_MAX), COLOR_R8_MIN))
#define COLOR_YUV_TO_G8(y, u, v)                (IM_MAX(IM_MIN(y - ((22554 * u + 46802 * v) >> 16), COLOR_G8_MAX), COLOR_G8_MIN))
#define COLOR_YUV_TO_B8(y, u, v)                (IM_MAX(IM_MIN(y + ((116130 * u) >> 16), COLOR_B8_MAX), COLOR_B8_MIN))
typedef enum {
...
#define IMAGE_RGB888_LINE_LEN_BYTES(image)       (IMAGE_RGB888_LINE_LEN(image) * sizeof(pixel_rgb_t))
...
({ \
    ...
    __typeof__ (x) _x = (x); \
    __typeof__ (y) _y = (y); \
    ((pixel_rgb_t *) _image->data)[(_image->w * _y) + _x]; \
})
...
({ \
    ...
    __typeof__ (y) _y = (y); \
    __typeof__ (v) _v = (v); \
    ((pixel_rgb_t *) _image->data)[(_image->w * _y) + _x] = _v; \
})
...
({ \
    __typeof__ (image) _image = (image); \
    __typeof__ (y) _y = (y); \
   ((pixel_rgb_t *) _image->data) + (_image->w * _y); \
})
...
int8_t imlib_rgb888_to_l(pixel_rgb_t pixel);
int8_t imlib_rgb888_to_a(pixel_rgb_t pixel);
int8_t imlib_rgb888_to_b(pixel_rgb_t pixel);
void imlib_rgb888_to_lab(pixel_rgb_t pixel, uint8_t *l, int8_t *a, int8_t *b);
uint16_t imlib_lab_to_rgb(uint8_t l, int8_t a, int8_t b);
uint16_t imlib_yuv_to_rgb(uint8_t y, int8_t u, int8_t v);
pixel_rgb_t imlib_yuv_to_rgb888(uint8_t y, int8_t u, int8_t v);
pixel_rgb_t imlib_lab_to_rgb888(uint8_t l, int8_t a, int8_t b);
