...
component_name = "maixcdk-example"
...
# Get version info from version.py file
with open("{}/version.py".format(component_name), "r", encoding="utf-8") as f:
    vars = {}
    exec(f.read(), vars)
...
setup(
    ...
    description='example component for MaixCDK',
    ...
    package_data={
        "" : ["LICENSE", "README.md"],
        # maixcdk-example package's all files and directories
        "maixcdk-example" : ["*", "**/*"],
    },
    ...
    entry_points={
        'console_scripts': [
            # 'maixcdk-example=maixcdk-example.__main__:main'
        ],
        # 'gui_scripts': [
        # ],
    }
