...
audio::RecorderPause r = audio::RecorderPause(path_record, sample_rate_record, format_record, channel_record);
audio::PlayerBlock   p = audio::PlayerBlock(path_record, sample_rate_record, format_record, channel_record);
