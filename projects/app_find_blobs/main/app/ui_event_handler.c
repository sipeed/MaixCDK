...
extern lv_obj_t *ui_red_btn;
extern lv_obj_t *ui_green_btn;
...
void event_touch_red_cb(lv_event_t * e)
{
    ...
    if (code == LV_EVENT_CLICKED) {
        if (lv_obj_get_state(obj) != LV_STATE_FOCUSED) {
            lv_obj_remove_state(ui_green_btn, LV_STATE_CHECKED);
            lv_obj_remove_state(ui_blue_btn, LV_STATE_CHECKED);
            lv_obj_remove_state(ui_user_btn, LV_STATE_CHECKED);
            DEBUG_PRT("touch red btn!\n");
            priv.red_btn_is_touch_flag = 1;
            priv.green_btn_is_touch_flag = 0;
            priv.blue_btn_is_touch_flag = 0;
            priv.user_btn_is_touch_flag = 0;

            ui_set_lmin_value(0);
            ui_set_lmax_value(80);
            ui_set_amin_value(40);
            ui_set_amax_value(80);
            ui_set_bmin_value(10);
            ui_set_bmax_value(80);
...
void event_touch_green_cb(lv_event_t * e)
{
    ...
    if (code == LV_EVENT_CLICKED) {
        if (lv_obj_get_state(obj) != LV_STATE_FOCUSED) {
            lv_obj_remove_state(ui_red_btn, LV_STATE_CHECKED);
            lv_obj_remove_state(ui_blue_btn, LV_STATE_CHECKED);
            lv_obj_remove_state(ui_user_btn, LV_STATE_CHECKED);
            DEBUG_PRT("touch green btn!\n");
            priv.green_btn_is_touch_flag = 1;
            priv.red_btn_is_touch_flag = 0;
            priv.blue_btn_is_touch_flag = 0;
            priv.user_btn_is_touch_flag = 0;

            ui_set_lmin_value(0);
            ui_set_lmax_value(80);
            ui_set_amin_value(-120);
            ui_set_amax_value(-10);
            ui_set_bmin_value(0);
            ui_set_bmax_value(30);
...
void event_touch_blue_cb(lv_event_t * e)
{
    ...
    if (code == LV_EVENT_CLICKED) {
        if (lv_obj_get_state(obj) != LV_STATE_FOCUSED) {
            ...
            lv_obj_remove_state(ui_red_btn, LV_STATE_CHECKED);
            lv_obj_remove_state(ui_user_btn, LV_STATE_CHECKED);
            DEBUG_PRT("touch blue btn!\n");
            priv.blue_btn_is_touch_flag = 1;
            priv.green_btn_is_touch_flag = 0;
            priv.red_btn_is_touch_flag = 0;
            priv.user_btn_is_touch_flag = 0;
...
void event_touch_user_cb(lv_event_t * e)
{
    ...
    if (code == LV_EVENT_CLICKED) {
        if (lv_obj_get_state(obj) != LV_STATE_FOCUSED) {
            ...
            lv_obj_remove_state(ui_blue_btn, LV_STATE_CHECKED);
            lv_obj_remove_state(ui_red_btn, LV_STATE_CHECKED);
            DEBUG_PRT("touch user btn!\n");
            priv.user_btn_is_touch_flag = 1;
            priv.green_btn_is_touch_flag = 0;
            priv.blue_btn_is_touch_flag = 0;
            priv.red_btn_is_touch_flag = 0;
...
void event_touch_color_btn_cb(lv_event_t * e)
{
    ...
    if (code == LV_EVENT_CLICKED) {
        ...
        int lmin = lab->l - 10 < 0 ? 0 : lab->l - 10;
        int lmax = lab->l + 10 > 100 ? 100 : lab->l + 10;
