...
parser = argparse.ArgumentParser(prog="flash", description="flash program to device", add_help=False)
...
parser.add_argument("-p", "--port", help="port to connect", default="")
parser.add_argument("cmd", help="flash command", choices=["", "clean_conf"], default="")
